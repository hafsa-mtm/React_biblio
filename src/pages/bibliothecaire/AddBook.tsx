...
import { ArrowLeft, BookOpen, Upload, PlusCircle, CheckCircle, XCircle, Info } from "lucide-react";
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-amber-100/80 mt-1">
                  Remplissez les informations du nouvel ouvrage
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      {imagePreview && (
                        <div className="mt-4">
                          <p className="text-brown-900 font-medium mb-2">Aperçu :</p>
